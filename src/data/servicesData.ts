...
export const servicesData: ServiceDetail[] = [
  {
    ...
    seoTitle: 'Cloud Solutions & Services | VAM VORA Technologies',
    seoDescription: 'Enterprise cloud solutions and services: scalable cloud infrastructure, zero-downtime migration, disaster recovery, virtual servers, and FinOps governance.',
    h1Title: 'Cloud Solutions for Modern Businesses',
  ...
  },
  {
    ...
    slug: 'ai-solutions',
    title: 'AI Solutions',
    seoTitle: 'AI Solutions for Business | VAM VORA Technologies',
    seoDescription: 'Practical AI solutions and business automation for modern enterprises. Streamline workflows, deploy private RAG knowledge assistants, and eliminate operational bottlenecks.',
    h1Title: 'AI Solutions & Business Automation',
  ...
  },
  {
    ...
    slug: 'cybersecurity',
    title: 'Cybersecurity',
    seoTitle: 'Cybersecurity Services for Businesses | VAM VORA Technologies',
    seoDescription: 'Proactive cybersecurity services for businesses: zero-trust defense, endpoint detection and response (EDR), ransomware mitigation, and continuous threat monitoring.',
    h1Title: 'Cybersecurity Solutions for Businesses',
    ...
    useCases: [
      {
        ...
        result: 'Proactively intercepted targeted wire fraud and phishing attempts with zero financial loss.'
      },
      {
